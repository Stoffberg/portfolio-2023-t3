...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (linesOfCode < MAX_LINES_OF_CODE) setLinesOfCode(NXIValue(linesOfCode, MAX_LINES_OF_CODE, 3689, 5));
      if (projects < MAX_PROJECTS) setProjects(NXIValue(projects, MAX_PROJECTS, 1, 12));

      setTimeBetweenInterval(timeBetweenInterval + 1);

      if (Math.round(linesOfCode) === MAX_LINES_OF_CODE) setStopAnimation(true);
    }, timeBetweenInterval);

    return () => clearInterval(interval);
  }, [linesOfCode, projects, stopAnimation, timeBetweenInterval]);
    ...
    <>
      ...
      <main className="min-h-screen bg-main-dark pb-20 tracking-tight">
        ...
        <section className="mx-auto max-w-7xl">
          <h1 className="mt-16 mb-4 text-center text-4xl font-bold text-white">Interested Technologies</h1>
          <p className="mb-8 text-center text-main-light">This is a small collection of randomly selected technologies I&apos;ve used over the years</p>
          <div className="relative grid grid-cols-3 gap-8 px-4">
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  Next.js is a hybrid framework for building heavily optimized web applications in React. It empowers me to quickly mock up websites that used
                  to take weeks in the span of a few hours.
                </p>
              </div>
            </div>
            ...
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  Prisma is an ORM for Typescipt that works with most SQL databases and MongoDB. It is a great tool for quickly connecting to databases and
                  preforming queries with typesafety guaranteed.
                </p>
              </div>
            </div>
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  Tailwind CSS is a css framework that allows you to quickly and effectively style a webpage. It lets me enter a flow state and focus on the
                  logic of the application instead of the styling.
                </p>
              </div>
            </div>
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  It provides a free drop-in authentication solution for Next.js. Can be set up to work with databases, web tokens and practically any OAuth
                  provider. All the complexity is handled by default.
                </p>
              </div>
            </div>
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border-x border-b border-main-light bg-main-medium p-4">
                <p className="text-main-light">
                  Typescript is a superset of JavaScript that adds static typing to the language. I use it in conjunction with tRPC to build my APIs or wuth
                  generics to build typesafe libraries.
                </p>
              </div>
            </div>
            ...
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  tRPC connects your frontend logic to your backend logic by providing type inference and a unified API for both. Iterations are done with ease
                  and without any fear of breaking the frontend.
                </p>
              </div>
            </div>
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  PlanetScale is a MySQL compatable, database-as-a-service that makes it easy to host a website with a database that scales with your traffic.
                  It&apos;s serverless and has an extremely generous free tier.
                </p>
              </div>
            </div>
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  Vercel is a hosting platform that makes deploying an application to the web as simple as connecting GitHub to the project. Automatic
                  deployments for your fullstack application gets done in about a minute.
                </p>
              </div>
            </div>
            <div className="z-10 flex flex-col">
              ...
              <div className="grow rounded-b-md border border-main-border bg-main-medium p-4">
                <p className="text-main-light">
                  Solid.js is a fontend framework with APIs similar to React.js but with major speed and quality of life improvements. I generally prefer using
                  Solid if I&apos;m not using Next.js.
                </p>
              </div>
            </div>
